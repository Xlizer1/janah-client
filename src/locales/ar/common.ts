const arTranslations = {
  ...
  "admin.users.searchUsers": "البحث في المستخدمين...",
  ...
  "admin.users.confirmActivation": "تأكيد التفعيل",
  "admin.users.confirmDeactivation": "تأكيد إلغاء التفعيل",
  ...
  "admin.analytics.subtitle":
    "وظائف التحليلات المفصلة قريباً. ستتضمن اتجاهات المبيعات وأداء المنتجات ورؤى الفئات.",

  // Admin Settings
  "admin.settings.title": "إعدادات المشرف",
  "admin.settings.subtitle": "تكوين تفضيلات المشرف وإعدادات النظام",

  // Admin Bulk Operations
  "admin.bulk.title": "العمليات المجمعة",
  "admin.bulk.subtitle": "تنفيذ إجراءات مجمعة على المنتجات والفئات",

  // Admin Import/Export
  "admin.importExport.title": "استيراد/تصدير",
  "admin.importExport.subtitle": "استيراد وتصدير البيانات",
